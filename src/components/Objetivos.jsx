    ...
    <>
      ...
      <div className="w-full grid lg:grid-cols-3 grid-cols-1 gap-y-32 place-items-center items-center xl:-mt-[36rem] lg:-mt-[24rem] md:-mb-[0] z-100">
          ...
          <article className="w-3/5 h-full bg-gray-100 relative rounded-3xl shadow-2xl	">
            ...
            <p className="sm:text-left text-center w-full py-14 sm:px-8 px-10">Un problema común en los pescadores recurrentes es la falta de pique, sentir que va a un lugar donde solo se aburren a esperar que pase algo que nunca pasa. Ellos deben investigar diferentes foros y escuchar de otras personas experiencias o consejos que no funcionan o les hacen perder el tiempo.</p>
          </article>
          ...
          <article className="w-3/5 h-full bg-gray-100 relative rounded-3xl shadow-2xl	">
            ...
            <p className="sm:text-left text-center w-full py-14 sm:px-8 px-10">La falta de información es altísima en el sector y por eso con nuestra app apuntamos a las familias o grupos de amigos que buscan juntarse a comer un asado y pescar en un camping una tarde o un fin de semana entero.</p>
          </article>
          ...
          <article className="w-3/5 h-full bg-gray-100 relative rounded-3xl shadow-2xl	">
            ...
            <p className="sm:text-left text-center w-full py-14 sm:px-8 px-10">Proponemos una app en la que el usuario cargue su perfil y pueda intercambiar información validada de sitios a donde pescar, los peces que pueden sacar alli y con que carnadas sacarlas. <br /> <span className="text-blue-500">Tener la experiencia de un profesional sin ser profesional.</span></p>
          </article>
      </div>
    </>
  )
