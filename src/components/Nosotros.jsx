    ...
    <>
        <article className={`w-full flex flex-row flex-wrap items-center justify-between`}>
              <div className="sm:w-1/3 w-1/2 mx-auto absolute z-10 sm:right-24 right-1/4 text-white ">
                  ...
                  <p>Somos los creadores de una app dedicada a brindar información, tips, lugares para personas que tengan que ir a pescar. Brinda lugares de pesca segura y cómoda para todos los usuarios que ingresen a su perfil.</p>
              </div>
